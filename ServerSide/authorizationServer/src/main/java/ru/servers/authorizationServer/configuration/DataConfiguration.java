package ru.servers.authorizationServer.configuration;
...
@ComponentScan("ru.servers.authorizationServer.data.entity")
@EnableJpaRepositories("ru.servers.authorizationServer.data.dao")
