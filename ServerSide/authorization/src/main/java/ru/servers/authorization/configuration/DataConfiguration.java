package ru.servers.authorization.configuration;
...
@ComponentScan("ru.servers.authorization.data.entity")
@EnableJpaRepositories("ru.servers.authorization.data.dao")
