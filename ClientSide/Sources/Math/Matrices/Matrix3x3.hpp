...
namespace Math {
    ...
    public:
        ...
        explicit Matrix3x3(const Type (&array)[MATRIX_SIZE]) noexcept;
    ...
    template<class Type>
    Matrix3x3<Type>::Matrix3x3(const Matrix3x3& anotherMatrix) noexcept
    {
    ...
    template<class Type>
    Matrix3x3<Type>::Matrix3x3(Matrix3x3&& anotherMatrix) noexcept
    {
